...
import { CampMoment } from "@/components/motion/CampMoment";
...
// football sketch (A05) joins it when that engraving is sourced. CampMoment pastes the clipping
// and stamps the medals.
    ...
    <section id="camp" aria-labelledby="camp-title" className="chapter shell">
      <CampMoment>
        <Page spine="left" className="mx-auto max-w-3xl">
          ...
          <article
            data-moment="clipping"
            className="paper-light shadow-pasted mt-8 -rotate-[0.5deg] px-6 py-6 md:px-8"
          >
